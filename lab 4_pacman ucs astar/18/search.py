...
def uniformCostSearch(problem):
    ...
    while(q1.isEmpty() != True):
        ...
        for x in problem.getSuccessors(state1):
            ...
            succ2 = x[1]
            succ3 = x[2]
            if succ1 not in color.keys():
                priority = n[2] + succ3
                
                if succ1 in cost.keys():
                    if cost[succ1] <= priority:
                        continue
                    
                q1.push((succ1,succ2,priority),priority)
                cost[succ1] = priority
                par[succ1] = state1
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while(q1.isEmpty() != True):
        ...
        for x in problem.getSuccessors(state1):
            ...
            succ3 = x[2]
            if succ1 not in color.keys():
                priority = n[2] + succ3 + heuristic(succ1 ,problem)
                
                if succ1 in cost.keys():
                    if cost[succ1] <= priority:
                        continue
                    
                q1.push((succ1, succ2, n[2] + succ3),priority)
                cost[succ1] = priority
                par[succ1] = state1
